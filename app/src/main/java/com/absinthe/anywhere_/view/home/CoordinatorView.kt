  ...
  override fun onTouchEvent(motionEvent: MotionEvent): Boolean {
    when (motionEvent.action) {
      ...
      MotionEvent.ACTION_MOVE -> {
        ...
        // 移动悬浮窗
        targetView.apply {
          x = (x + tranX.toInt()).coerceAtLeast(0f)
            .coerceAtMost((this@CoordinatorView.measuredWidth - measuredWidth).toFloat())
          y = (y + tranY.toInt()).coerceAtLeast(0f)
            .coerceAtMost((this@CoordinatorView.measuredHeight - measuredHeight).toFloat())
        }
