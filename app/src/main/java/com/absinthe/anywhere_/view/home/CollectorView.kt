...
class CollectorView(context: Context, binder: ICollectorService) : LinearLayout(context) {

  private val binderRef: WeakReference<ICollectorService> = WeakReference(binder)
